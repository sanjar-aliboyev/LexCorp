...
export const metadata = {
  ...
  metadataBase: new URL('https://lexcorp.uz'), // Replace with your actual domain later
};
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              'name': 'LexCorp',
              'url': 'https://lexcorp.uz', // Replace with your actual domain
              'logo': 'https://lexcorp.uz/logo.png', // Replace with your actual logo URL
